...
%% show the image.
close all; 
im = imread('/Users/wangerxiao/Documents/MATLAB/edifice-rex-master/data/Norfolk_01_training.tif');
imshow(im);
...
lines = lsd('./Users/wangerxiao/Documents/MATLAB/edifice-rex-master/data/Norfolk_01_training.tif');
%% plot the lines.
hold on;
